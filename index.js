...
console.log(color(`${spc2}           [ Created by: YUDAMODS ]`, randomcolor));
...
console.log(color(`${spc3}                    [•]`, randomcolor), color(`Author      : YUDAMODS`, randomcolor));
console.log(color(`${spc3}                    [•]`, randomcolor), color(`Base Ori By : YUDAMODS`, randomcolor));
console.log(color(`${spc4}                       < =============================== >`, randomcolor));
